...
import json
import os
from HT10.config import Config
from HT10.complex_http_operator import ComplexHttpOperator
...
dag = DAG(
    dag_id="HT10_dag",
    description="Hometask of 10th lesson",
...
login_task = SimpleHttpOperator(
                       task_id = "robodreams_api_login_ht10",
                       dag = dag,
                       http_conn_id="rd_api",
...
load_task = ComplexHttpOperator(
                       ...
                       headers = {'content-type': 'text/plain',
                                  'Authorization': 'JWT ' + '{{json.loads(ti.xcom_pull(task_ids="robodreams_api_login_ht10", key="return_value"))["access_token"]}}',
                                  },
